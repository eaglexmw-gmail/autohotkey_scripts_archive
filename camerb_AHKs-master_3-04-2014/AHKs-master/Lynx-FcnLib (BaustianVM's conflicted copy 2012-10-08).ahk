...
TestDownloadProtocol(testProtocol)
{
   ...
   ;debug("hello5")
   ;UrlDownloadToFile, %url%, C:\temp\lynx_upgrade_files\test.txt
   ;debug("hello6")
   ;joe := FileRead(file)
   ;debug("hello7")
...
{
   ;SC failure apache2.2 reset= 432000  actions= restart/30000/restart/60000/restart/60000
...
GetSqlVersion()
{
   ...
   lynx_log("SQL version was " . SQLversion)
