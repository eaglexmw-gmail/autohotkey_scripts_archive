...
DownloadAllLynxFilesForUpgrade()
{
   ...
   ;FileRemoveDir, C:\temp\lynx_upgrade_files\, 1
   ;FileRemoveDir, C:\temp\lynx_upgrade_files\ActivePerl\, 1
   ;FileRemoveDir, C:\temp\lynx_upgrade_files\apache\, 1
   ;FileRemoveDir, C:\temp\lynx_upgrade_files\7.12\, 1
   ...
   ;{
      ...
      ;lynx_message("Correction: a custom zip was detected, the custom zip will be used for the update")
      ;customZip := true
   ;}
