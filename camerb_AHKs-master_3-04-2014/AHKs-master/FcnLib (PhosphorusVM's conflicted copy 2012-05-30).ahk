...
;WRITEME make auto anonymouse only happen on work compy


;WRITEME DeleteConflictedCopies(folderPath, excludePath="")


;WRITEME DeleteConflictedCopies(path)


;WRITEME fireflyremote-start gotomeeting-imacro


;WRITEME make a basic tail viewer in AHK
