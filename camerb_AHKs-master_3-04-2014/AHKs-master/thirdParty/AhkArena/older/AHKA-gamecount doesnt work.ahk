...
if 0 < 2
	...
	Gui, 3:Add, Text,, Player 1 file:
	Gui, 3:Add, DropDownList, vChoicePlayer1, %FileList%
	Gui, 3:Add, Text,, Player 2 file:
	Gui, 3:Add, DropDownList, vChoicePlayer2, %FileList%
	Gui, 3:Add, Text,, Number of games to play
	Gui, 3:Add, Edit, vGameCount
	Gui, 3:Add, Text,, (Games will automatically continue until the number of games chosen have been played.)
	Gui, 3:Add, Button, Default, OK
	Gui, 3:Show,, AHK Arena Game Properties
	WinWaitClose, AHK Arena Game Properties ahk_class AutoHotkeyGUI
