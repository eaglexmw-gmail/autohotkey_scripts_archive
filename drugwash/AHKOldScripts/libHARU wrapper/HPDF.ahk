...
{
   Return, DllCall("libhpdf\HPDF_Page_LineTo", "UInt", hPage, "Float", x, "Float", y, "Cdecl int")
}

HPDF_Page_MoveTextPos(ByRef hPage, x, y)
{
   Return, DllCall("libhpdf\HPDF_Page_MoveTextPos", "UInt", hPage, "Float", x, "Float", y, "Cdecl int")
}

HPDF_Page_MoveTextPos2(ByRef hPage, x, y)
{
   Return, DllCall("libhpdf\HPDF_Page_MoveTextPos2", "UInt", hPage, "Float", x, "Float", y, "Cdecl int")
}
...
HPDF_Page_TextRect(ByRef hPage, left, top, right, bottom, text, align, ByRef len)
{
   ...
   Return, DllCall("libhpdf\HPDF_Page_TextRect", "UInt", hPage, "Float", left, "Float", top, "Float", right, "Float", bottom, "Str", text, "Int", thisAlignment, "UInt", len, "Cdecl int")
}
...
{
   Return, DllCall("libhpdf\HPDF_Page_GetGMode", "UInt", hPage, "Cdecl int")
}

HPDF_Page_GetCurrentPos(ByRef hPage)
{
   Return, DllCall("libhpdf\HPDF_Page_GetCurrentPos", "UInt", hPage, "Cdecl int")
}

HPDF_Page_GetCurrentTextPos(ByRef hPage)
{
   Return, DllCall("libhpdf\HPDF_Page_GetCurrentTextPos", "UInt", hPage, "Cdecl int")
}
...
{
   x := NumGet(point,0,"Float")
   y := NumGet(point,4,"Float")
}
