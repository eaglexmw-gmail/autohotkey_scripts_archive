...
Menu, Tray, Icon, %ScanFolder%\shell32.dll, 46   ;icon for taskbar and for process in task manager
...
;#############   Browse to the folder from where the search should start   ####
BtnBrowseFolder:
  Gui, 1:+OwnDialogs
