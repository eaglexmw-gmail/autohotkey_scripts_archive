...
defNT = 0			; default tray icon state
defAuto = 0			; default autostart with Windows
...
if ! FileExist(initFile)
	...
	themed =				; OS theme is by default DISABLED
...
muted := mutt=3 ? "ON" : "OFF"
Progress,B2 ZH0 FM14 CTFF00FF CW0 W140,,MUTE %muted%,,Arial
SetTimer, vol_BarOff, %vol_DT%
getval:
...
Gui, Add, Radio, xp+15 y75 w280 hp vs1 gss1 Group Checked, Soundcard #1
Gui, Add, Radio, xp y+2 wp hp Hidden vs2 gss2, Soundcard #2
Gui, Add, Radio, xp y+2 wp hp Hidden vs3 gss3, Soundcard #3
...
Gui, Add, Text, x+1 yp w280 h14 Hidden vsd1, Soundcard #1
Gui, Add, Text, x20 y+6 w10 h14 Hidden vsn2, 2.
Gui, Add, Text, x+1 yp w280 h14 Hidden vsd2, Soundcard #2
Gui, Add, Text, x20 y+6 w10 h14 Hidden vsn3, 3.
Gui, Add, Text, x+1 yp w280 h14 Hidden vsd3, Soundcard #3
...
if ctrl in Static4,Static9,Static39,Static41,Static43,Static45,Static47,Static49
