...
Gui, Add, GroupBox, x6 y203 w181 h165, Appearance
Gui, Add, Text, x14 y220 w100 h16, Progress bar width:
Gui, Add, Button, x116 y217 w62 h21, Default
...
Gui, Add, Text, x14 y320 w40 h14, Master:
Gui, Add, Text, x14 y334 w40 h14, Wave:
Gui, Add, Text, x14 y348 w40 h14, Backgr:
Gui, Add, Button, x116 y316 w62 h22, Default
Gui, Add, Checkbox, x116 y340 w68 h19, XP theme
Gui, Add, GroupBox, x193 y203 w275 h165, Hotkeys
Gui, Add, Text, x198 y221 w67 h14, Master up:
Gui, Add, Edit, x268 y218 w110 h19, CTRL+Up
