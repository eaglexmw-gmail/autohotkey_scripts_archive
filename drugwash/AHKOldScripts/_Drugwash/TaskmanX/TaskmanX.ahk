...
;Gui, Add, ListBox, x20 y2 w360 h70 +0x100 -0x800 +LBS_MULTICOLUMN +LBS_OWNERDRAWVARIABLE -LBS_HASSTRINGS vilist ginfo
Gui, Add, ListBox, x20 y2 w360 h70 +0x100 +0x50111311 +0x00000204 vilist ginfo
lib := IL_Create(1, 1, 1)
/*
******************
 disabled for ListBox
...
;		LV_Add("Icon" . count) ; disabled for ListBox
;********************
; this is for ListBox
if h_icon
;	GuiControl,, ilist, %h_icon%
;  SendMessage, 0x1307, 999, h_icon, %ilist%  ; 0x1307 is TCM_INSERTITEM
   SendMessage, 0x1303, 0, lib, %ilist%
;********************
		noicon :=
