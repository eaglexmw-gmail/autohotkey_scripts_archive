...
Gui, Add, GroupBox, x7 y32 w310 h80, Pack data
...
Gui, Add, Edit, x98 y46 w210 h17 vpname gvalid
Gui, Add, Edit, x98 y67 w210 h17 vpauthor gvalid
Gui, Add, Edit, x98 y88 w210 h17 vpupdater gvalid
Gui, Add, GroupBox, x322 y32 w87 h166, Main
Gui, Add, Button, x329 y46 w74 h39, &Load
Gui, Add, Button, x329 y87 w74 h39, &Save
Gui, Add, Checkbox, x337 y128 w58 h32 vmakeF grefresh, Create folders
...
Gui, Add, Edit, x98 y127 w210 h17 ReadOnly vcodes
Gui, Add, Text, x16 y149 w80 h16 Right Hidden ve1, Custom codes :
Gui, Add, Edit, x98 y148 w210 h17 Hidden ve2 gvalid
...
Gui, Add, Button, x329 y308 w36 h20 Hidden ve6, « ±
Gui, Add, Button, x367 y308 w36 h20 Hidden ve7, ± »
...
Gui, Add, Radio, x421 y152 w60 h16 gdoAll, all
Gui, Add, Radio, x421 y173 w60 h16 Checked vselP gdoSel, select
Gui, Add, TreeView, x482 y46 w104 h150 Checked Sort -HScroll -Lines AltSubmit vProto gdoProto
gosub iniP
;-------- ANIGIF CODE HERE ------------
Gui +LastFound
guiID := WinExist()
...
If hAniGif is not integer
	MsgBox %hAniGif1%
Gui Add, Button, x329 y438 w36 h19 gAniGifZ+, ++
Gui Add, Button, x367 y438 w36 h19 gAniGifZ-, – –
;-------- END ANIGIF CODE ------------
...
Gui, Add, Text, x414 y559 w165 h14 Hidden ve8 cBlue Right gopenIni, %inipath%
