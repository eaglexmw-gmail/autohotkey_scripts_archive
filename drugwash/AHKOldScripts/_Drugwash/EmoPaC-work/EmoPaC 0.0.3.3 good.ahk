...
Gui, Add, Button, 0x8000 x490 y1 w100 h34 Right AltSubmit BackgroundTrans vabt gabout, by Drugwash `n©2008%A_Space%
abt_TT := "About EmoPac"
...
if Unicode
	...
	Gui, Add, TreeView, x482 y46 w104 h150 Checked Sort -HScroll -Lines 0x1000 AltSubmit vProto gdoProto AltSubmit
gosub iniP
;-------- ANIGIF CODE HERE ------------
Gui +LastFound
guiID := WinExist()
...
Gui, Add, Picture, 0x40 AltSubmit Hidden x350 y398 vprev, %debugpath%
...
Loop, %countP%
	...
	if exp
		...
		FileAppend, # %pname% by %pauthor%`n, %filename1%
		}
