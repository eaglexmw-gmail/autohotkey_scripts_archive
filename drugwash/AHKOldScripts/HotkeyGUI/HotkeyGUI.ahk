...
HotkeyGUI(p_GUI=""
    ...
    if HG_StandardKeysView
        HG_KeyList=
           (ltrim join
            AÉBÉCÉDÉEÉFÉGÉHÉIÉJÉKÉLÉMÉNÉOÉPÉQÉRÉSÉTÉUÉVÉWÉXÉYÉZÉ
            0É1É2É3É4É5É6É7É8É9É0É
            ``É-É=É[É]É`\É;É
            'É,É.É/É
            SpaceÉTabÉEnterÉEscapeÉBackspaceÉDeleteÉ
            ScrollLockÉCapsLockÉNumLockÉ
            PrintScreenÉCtrlBreakÉPauseÉBreakÉ
            InsertÉHomeÉEndÉPgUpÉPgDnÉ
            UpÉDownÉLeftÉRightÉ
           )
    ...
    if HG_FunctionKeysView
        HG_KeyList=
           (ltrim join
            F1ÉF2ÉF3ÉF4ÉF5ÉF6ÉF7ÉF8ÉF9ÉF10ÉF11ÉF12É
            F13ÉF14ÉF15ÉF16ÉF17ÉF18ÉF19ÉF20ÉF21ÉF22ÉF23ÉF24
           )
    ...
    if HG_NumpadKeysView
        HG_KeyList=
           (ltrim join
            NumLockÉNumpadDivÉNumpadMultÉNumpadAddÉNumpadSubÉNumpadEnterÉ
            NumpadDelÉNumpadInsÉNumpadClearÉNumpadUpÉNumpadDownÉNumpadLeftÉ
            NumpadRightÉNumpadHomeÉNumpadEndÉNumpadPgUpÉNumpadPgDnÉNumpad0É
            Numpad1ÉNumpad2ÉNumpad3ÉNumpad4ÉNumpad5ÉNumpad6ÉNumpad7ÉNumpad8É
            Numpad9ÉNumpadDot
           )
    ...
    ;-- Mouse
    if HG_MouseKeysView
        HG_KeyList=LButtonÉRButtonÉMButtonÉWheelDownÉWheelUpÉXButton1ÉXButton2
    ...
    if HG_MultimediaKeysView  
        HG_KeyList=
           (ltrim join
            Browser_BackÉBrowser_ForwardÉBrowser_RefreshÉBrowser_StopÉ
            Browser_SearchÉBrowser_FavoritesÉBrowser_HomeÉVolume_MuteÉ
            Volume_DownÉVolume_UpÉMedia_NextÉMedia_PrevÉMedia_StopÉ
            Media_Play_PauseÉLaunch_MailÉLaunch_MediaÉLaunch_App1ÉLaunch_App2É
           )
    
    
    ;-- Special
    if HG_SpecialKeysView
        HG_KeyList=HelpÉSleep
