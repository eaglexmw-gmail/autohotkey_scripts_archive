...
;	Run, %A_ProgramFIles%\Internet Explorer\iexplore "%A_ScriptDir%\Toolbar.html#%txt%"
	Run,  %A_ScriptDir%\Toolbar.html#%txt%
return
...
MakeTestGui(w, h)
{
	...
	d=10
	Gui, Add, BUTTON, w110 X+%d% yp gOnBtn section, Add
	Gui, Add, BUTTON, w110 X+%d% yp gOnBtn, Insert
	Gui, Add, BUTTON, w110 x+%d% yp gOnBtn, Define

	Gui, Add, BUTTON, w110 Xs gOnBtn, Delete
	Gui, Add, BUTTON, w110 X+%d% yp gOnBtn, Clear
	Gui, Add, BUTTON, w110 X+%d%	gOnBtn, Count

	Gui, Add, BUTTON, w110 Xs  gOnBtn, Customize
	Gui, Add, BUTTON, w110 X+%d% yp gOnBtn, ToggleStyle
	Gui, Add, BUTTON, w110 X+%d% yp gOnBtn, GetButton

	Gui, Add, BUTTON, w110 Xs  gOnBtn, SetButtonWidth
	Gui, Add, BUTTON, w110 x+%d% yp gOnBtn, SetButtonSize
	Gui, Add, BUTTON, w110 x+%d% gOnBtn, SetButton
