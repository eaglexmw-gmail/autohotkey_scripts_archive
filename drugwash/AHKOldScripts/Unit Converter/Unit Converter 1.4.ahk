...
Gui, Margin, -2, 3
Gui, Add, GroupBox, x-5 y-10 w250 h93 cblack,
Gui, Add, GroupBox, x-5 y-9 w250 h93 cblack,
Gui, Add, Radio, x4 y87 h20 checked greg, Regular
Gui, Add, Radio, x75 y87 h20 gsci, Scientific
Gui, Add, Edit, x150 y87 w35 h18 gRpre vRP Hidden,
Gui, Add, UpDown, Range1-9 0x80, 2
Gui, Add, Text, x+3 yp+3 Hide, decimals

Gui, Add, DropDownList, x52 y4 w140 h20 r19 gunits vunits, Acceleration||Angle|Area|Density|Distance|Electric Current|Energy|Force|Heat Capacity|Heat Transfer Coefficient|Mass|Power|Pressure|Specific Heat|Speed|Temperature|Thermal Conductivity|Time|Volume|

Gui, Add, DropDownList, x6 y28 w100 h20 r15 vfrom gcalc,
Gui, Add, Text, x106 y28 w30 h20 +Center, To:
Gui, Add, DropDownList, x136 y28 w100 h20 r15 vto gcalc,
