...
Gui, Add, DropDownList, x75 y4 w145 h20 r24 gunits vunits, Acceleration||Angle|Area|Coeff. of Thermal Expansion|Density|Distance|Electric Current|Energy|Force|Heat Capacity|Heat Transfer Coefficient|Mass|Power|Pressure|Specific Heat|Speed|Temperature|Thermal Conductivity|Time|Volume|======================|Physical Constants|Mathematical Constants|CALCULATOR
...
gosub, units
gosub reg
Gui, Show, AutoSize, Unit Converter v1.7
Return
...
{
Guicontrol,, from, |
Guicontrol,, from, lb/cubic inch||lb/cubic foot|g/cc|kg/cubic meter|slugs/cubic foot
Guicontrol,, to, |
Guicontrol,, to, lb/cubic inch||lb/cubic foot|g/cc|kg/cubic meter|slugs/cubic foot
}
