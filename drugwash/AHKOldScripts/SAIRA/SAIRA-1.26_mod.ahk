...
Gui, 1: Add, Picture, x0 y0 w155 h135 0x10E vPreview
...
Gui, 1: Add, Picture, x0 y0 w745 h20 0x10E vProgress
...
LoadPreview(Preview, FileName, 1)
return

;##############################################################################################

LoadPreview(ByRef Variable, File, keepObj=0)
{
