...
r := DllCall("radmin32\NetFileEnum", "int", &sServerNameW, "Uint", 0, "Uint", 0, "Uint", 3, "int*", pFileInfo, "Uint", 0xFFFFFFFE, "Uint*", iCount, "Uint*", iTotal, "int", 0)
MsgBox, r=%r%`nError: %ErrorLevel%`niCount=%iCount%`niTotal=%iTotal%`npFileInfo=%pFileInfo%
;Check return value
...
If A_OSType in WIN32_NT
    ...
    DllCall("radmin32\NetApiBufferFree", "int", pFileInfo)
    ExitApp
