...
;
; $LastChangedDate: 2009-03-21 18:08:11 +0100 $
;
...
guihide:
  ...
  ; if GUI was show automatically and current window is Opera then
  ; send an ESC to cancel the selection, so that the GUI doesn't
