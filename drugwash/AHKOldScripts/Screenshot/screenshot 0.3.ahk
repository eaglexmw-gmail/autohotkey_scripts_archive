; http://www.autohotkey.com/forum/topic12012.html
...
;================================================================
   ...
   DllCall( "gdi32.dll\DeleteObject", "uint", hbm_buffer_full )
   DllCall( "gdi32.dll\DeleteDC"    , "uint", hdc_frame_full )
   DllCall( "gdi32.dll\DeleteDC"    , "uint", hdc_buffer_full )
ExitApp
