...
Check_Idle_Time:
  If A_TimeIdlePhysical < %Idle_Time_Before_Dimming%
    Return
  MouseGetPos, xMouseOrig, yMouseOrig
  If ((xMouseOrig <= 10) or (yMouseOrig <= 10)) ; hot-corner to keep screen on (e.g. watching a movie)
    Return
  SetTimer, Check_Idle_Time, Off
  Transparency =0
  Gosub, Create_Gui
