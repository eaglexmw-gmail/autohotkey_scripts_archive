...
GuiShow:
	...
	Gui , Add , Checkbox , x+20 yp w160 h20 vGui_NoDecompile Checked%NoDecompile% , %Lang_NoDecompile%
	Gui , Add , Checkbox , xs+140 y w180 h20 vGui_SaveIniInScript Checked%SaveIniInScript% , %Lang_SaveIniInScript%
...
_WRITE_INI(s_Ini_File)
{
	...
	If (FileExist(s_Ini_File) AND  Not SaveIniInScript)
	{
...
_SaveIniInScript()
{
	...
	In_File_Content := "/*`n * * * Compile_AHK SETTINGS BEGIN * * *`n`n"
				...
				. RegExReplace(In_File_Content , "/\*`n \* \* \* Compile_AHK SETTINGS BEGIN \* \* \*[\S\s]*\* \* \* Compile_AHK SETTINGS END \* \* \*`n\*/`n`n")
