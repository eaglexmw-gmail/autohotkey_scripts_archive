...
#define QHTM_H
	...
	#define Q_LIB_POST Q_PLATFORM Q_UNICODE Q_DEBUG 
		...
		#pragma comment( lib, "DataSource" Q_LIB_POST ".lib" )
		#pragma comment( lib, "ImgLib" Q_LIB_POST ".lib" )
		#pragma comment( lib, "libpng" Q_LIB_POST ".lib" )
		#pragma comment( lib, "ZLib" Q_LIB_POST ".lib" )
		#pragma comment( lib, "libjpg" Q_LIB_POST ".lib" )	
		#pragma comment( lib, "guitools" Q_LIB_POST ".lib" )
		#define Q_LIB_NAME	"qhtmS"
	#else	//	QHTM_LINK_STATIC_LIBS
		#define Q_LIB_NAME	"qhtm"
	#endif	//	QHTM_LINK_STATIC_LIBS

	#pragma message( "**** Linking against QHTM " Q_LIB_NAME Q_LIB_POST ".lib ****" )
	#pragma comment( lib, Q_LIB_NAME Q_LIB_POST ".lib" )
